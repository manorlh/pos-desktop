...
<head>
  <meta charset="utf-8" />
  <style>
    /* 80mm roll — printable ~72mm. Page = printable width so the right edge is
       not clipped, with symmetric 3mm padding. Keep in sync with
       THERMAL_PAGE_WIDTH_MM / THERMAL_SIDE_PADDING_MM in electron/main.ts.
       Font A body ≈ 12pt @ 203 DPI */
