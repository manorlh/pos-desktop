export const en = {
  ...
  settings: {
    ...
    mainLogTitle: 'App log (sync, Ably, print)',
    mainLogDesc:
      'Main-process log file on disk. Use this for Ably/sync troubleshooting on installed builds (DevTools only shows the UI).',
    mainLogRefresh: 'Refresh',
    mainLogOpenFolder: 'Open logs folder',
    mainLogCopy: 'Copy last 200 lines',
    mainLogEmpty: 'No log lines yet. Use the app, then refresh.',
    mainLogCopied: 'Log lines copied to clipboard.',
    mainLogCopyFailed: 'Could not copy to clipboard.',
    mainLogOpenFailed: 'Could not open logs folder.',
